...
import org.jetbrains.kotlin.fir.plugin.runners.AbstractFirLoadK2CompiledJsKotlinWithPluginTest
...
fun main(args: Array<String>) {
    ...
    generateTestGroupSuiteWithJUnit5 {
        ...
        testGroup("plugins/fir-plugin-prototype/tests-gen", "plugins/fir-plugin-prototype/testData") {
            ...
            testClass<AbstractFirLoadK2CompiledJsKotlinWithPluginTest> {
                model("firLoadK2Compiled")
            }
        }

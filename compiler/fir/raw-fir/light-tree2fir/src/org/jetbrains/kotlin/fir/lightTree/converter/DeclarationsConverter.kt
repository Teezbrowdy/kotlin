        ...
        return withChildClassName(SpecialNames.ANONYMOUS, isExpect = false) {
            ...
            buildAnonymousObjectExpression {
                ...
                anonymousObject = buildAnonymousObject {
                    ...
                    var delegatedConstructorCalls: List<DelegatedConstructorWrapper>? = null
                    ...
                    val classWrapper = ClassWrapper(
                        ...
                        delegatedSuperCalls = delegatedConstructorCalls ?: emptyList(),
                    )
                    //parse primary constructor
        ...
        val firDelegatedCall = runUnless(containingClassIsExpectClass) {
            ...
            if (classWrapper.delegatedSuperCalls.size <= 1) {
                ...
                buildMultiDelegatedConstructorCall {
                    delegatedConstructorCalls.addAll(classWrapper.delegatedSuperCalls.map { (delegatedSuperTypeRef, arguments, source) ->
